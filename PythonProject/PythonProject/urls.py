...
urlpatterns = [
    ...
    url(r'^RoomType/', include('apps.RoomType.urls', namespace='RoomType')),  # 房间类型模块
    url(r'^Room/', include('apps.Room.urls', namespace='Room')),  # 房间模块
    url(r'^BookOrder/', include('apps.BookOrder.urls', namespace='BookOrder')),  # 房间预订模块
